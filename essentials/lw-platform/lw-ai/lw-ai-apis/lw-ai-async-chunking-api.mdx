...
layout: stoplight
data: api-machine-learning-platform-async-chunking
private: true
doctype: reference
order: 75
---
...
|vectorQuantizationMethod |Vector quantization compresses data size, as well as reducing memory usage.
...
For more information, see [vector quantization](#vector-quantization).

|dimReductionSize |Used to reduce vector size while maintaining good quality. This field allows any integer above 0, but less than or equal to the vector dimension of the model. 
