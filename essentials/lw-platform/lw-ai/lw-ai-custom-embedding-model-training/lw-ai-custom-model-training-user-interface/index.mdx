...
icon: 'text-size'
subtitle: 'Lucidworks AI Custom model training'
order: 58
doctype: concept
---
...
The other embedding models you can use are the _pre-trained_ embedding models that Lucidworks deploys for every organization. For more information, see [Lucidworks AI Pre-trained embedding models](/lw-platform/ai/3vqfxe/pre-trained-embedding-models).
...
![Lucidworks AI custom model training user interface](/assets/images/lw-platform/lw-ai/lw-ai-custom-model-training-ui.png)
...
![Lucidworks AI custom model training details](/assets/images/lw-platform/lw-ai/lw-ai-model-details.png)
...
|State |Also referred to as `Training status`, this is the current status of the model. Options are:
...
|dataset_config |  The options for the dataset format used for training are:
...
|trainer_config |  The options for the trainer type used for training are:
...
![Lucidworks AI custom model error message](/assets/images/lw-platform/lw-ai/lw-ai-training-failed-error.png)

#### Summary

Click the **Summary** tab to view information about training metrics for the selected model.

![Lucidworks AI custom model training details summary](/assets/images/lw-platform/lw-ai/lw-ai-model-details-summary.png)
...
![Training details metrics value options](/assets/images/lw-platform/lw-ai/lw-ai-model-training-details-options.png)
...
![Training details metrics with value of hit@1](/assets/images/lw-platform/lw-ai/lw-ai-model-training-details-hit1.png)

### Deployment Details

The deployments screen displays information about each time you deployed the selected model.

![Lucidworks AI custom model deployments screen](/assets/images/lw-platform/lw-ai/lw-ai-model-details-deployment.png)
...
|State |The current status of the deployed model. Options are:
...
ifeval::["{audience-visibility}" == "beta"]
NOTE: For information about configuration options for a model, see [Models API](/lw-platform/ai/e63rmi/models-api). You can click **View API specification** for detailed descriptions and options for each field.
endif::[]
