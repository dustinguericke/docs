...
![Lucidworks AI integration details screen](/assets/images/lw-platform/lw-ai/lw-ai-integration-details.png)
...
|Client ID |Your organization’s unique identifier. For a self-hosted Fusion client integration, this value is unique to the specific integration. 
For more information, see [Credentials](/lw-platform/platform/oqzogo/apis-and-credentials#credentials).
