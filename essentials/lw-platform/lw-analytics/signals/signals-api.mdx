...
<dl><dt><strong>💡 TIP: View the API specification</strong></dt><dd>
...
3. If you haven’t configured embeds for this signal store, the "No embed token found" message displays. 
   ...
   ![No embed token found](/assets/images/lw-platform/analytics/signals-api-no-embed-token.png)
...
5. In the Embed Token section, click **Copy** and then paste the token into your codebase. To view the token, click **Show** or click **Hide** to prevent it from displaying. 
   ...
   ![Embed token not displayed](/assets/images/lw-platform/analytics/signals-api-embed-token-hidden.png)

   ![Embed token displayed](/assets/images/lw-platform/analytics/signals-api-embed-token-displayed.png)
...
<dl><dt><strong>💡 TIP: View API requests in different languages</strong></dt><dd>
...
![API specification language selection](/assets/images/lw-platform/analytics/signals-api-spec-language-selection.png)
</dd></dl>
