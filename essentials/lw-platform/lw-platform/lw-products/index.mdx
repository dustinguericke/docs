...
1. To grant permission to perform particular application functions for an existing user, click **+Add User**.
   ...
   ![Add user application permissions](/assets/images/lw-platform/products/lw-products-app-add-user-button.png)
2. Enter the Lucidworks user name. If the Lucidworks user account is not valid, you cannot add the user and permissions to the app. If the user is valid, you can select the permission role for the application.
   ...
   ![Add user name for application permissions](/assets/images/lw-platform/products/lw-products-app-add-username.png)
   ![Select application permissions](/assets/images/lw-platform/products/lw-products-app-add-user.png)
...
2. Click **Edit Permissions**.
   ...
   ![Edit application user permissions](/assets/images/lw-platform/products/lw-products-app-edit-permissions.png)
