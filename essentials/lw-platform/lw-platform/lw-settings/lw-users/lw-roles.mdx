...
| View specific applications | {check} | {check} | {check} | {nocheck} | {nocheck} | {check} |
| View all applications | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| View application usage dashboards | {check} | {check} | {check} | {check} | {nocheck} | {check} |
| Create new applications | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| Edit specific applications | {check} | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| Edit all applications | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| Invite new users | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| Remove or delete users | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| Edit user access to all applications | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| Edit user access to specific applications | {check} | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| Create data sources | {check} | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| View data sources | {check} | {check} | {check} | {nocheck} | {nocheck} | {check}  |
| View data source jobs | {check} | {check} | {check} | {nocheck} | {nocheck} | {check} |
| View data source job history | {check} | {check} | {nocheck} | {nocheck} | {check} | {nocheck} |
| Edit relevancy controls | {check} | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| View relevancy controls | {check} | {check} | {check} | {check} | {nocheck} | {check} |
| Edit embed access | {check} | {check} | {nocheck} | {nocheck} | {nocheck} | {nocheck} |
| View embed settings | {check} | {check} | {check} | {nocheck} | {check} | {nocheck} |
| Train custom embedding models | {check} | {check} | {nocheck} | {nocheck} | {nocheck} | {check} |
| Deploy custom embedding models | {check} | {check} | {nocheck} | {nocheck} | {nocheck} | {check} |
