...
| Dates | The date and time range for the rule. | Dates must be in ISO format. For example: `2024-12-10T19:29:34Z` |
...
![Create rule visual editor](/assets/images/lw-platform/commerce-studio/lw-cs-create-rule-home.png)
...
7. Click **Next**.
8. Click **Select Condition** and then select one or more [conditions](#conditions). You can select dates, field value, query, and query profile. When you select an option, additional fields may be required. 
9. Click **Next**.
10. Click the **Add Actions** menu and then select [an action](#actions). You can block, boost, bury, pin, or set values based on the previously-defined condition. When you select an option, additional fields may be required.
11. Click **Next**.
12. Review your rule’s settings, then click **Save**.
