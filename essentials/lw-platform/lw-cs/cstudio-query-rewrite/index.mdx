...
<dl><dt><strong>💡 TIP: When should I use a remove words query rewrite instead of an underperforming rewrite?</strong></dt><dd>
...
<div class="tab">
  <button class="tablinks btn_primary" onclick="openPage(event, 'tailtab')" id="defaultOpen">Underperforming Queries</button>
  <button class="tablinks btn_primary" onclick="openPage(event, 'misspelltab')">Misspelling Detections</button>
  <button class="tablinks btn_primary" onclick="openPage(event, 'phrasetab')">Phrase Detections</button>
  <button class="tablinks btn_primary" onclick="openPage(event, 'synonymtab')">Synonym Detections</button>
  <button class="tablinks btn_primary" onclick="openPage(event, 'removetab')">Word Removal</button>
</div>

<div class="tabcontent" id="tailtab" style="display: block">
...
<div class="tabcontent" id="misspelltab" style="display: none">
...
<div class="tabcontent" id="phrasetab" style="display: none">
...
<div class="tabcontent" id="synonymtab" style="display: none">
...
<div class="tabcontent" id="removetab" style="display: none">
